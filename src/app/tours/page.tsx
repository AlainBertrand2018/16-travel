...
function ToursPageContent() {
    ...
    useEffect(() => {
        ...
        if (pkgId) {
            ...
            if (pkg) {
                setActiveItem(pkg);
                // Scroll to top to ensure modal is visible if page is long
            ...
            <section id="st-section-tours-header" className="relative h-screen md:h-[70vh] flex flex-col items-center justify-center overflow-hidden text-center mb-16">
                ...
                <div className="relative z-10 px-6">
                    ...
                    <motion.h1
                        ...
                        className="text-[32px] sm:text-6xl lg:text-8xl xl:text-9xl font-display mb-8 text-white drop-shadow-2xl leading-tight"
                    >
